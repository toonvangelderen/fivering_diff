...
float   Far = 300.0;        /* The far clipping plane */
float   Boxdistance =3.25;
float   Distance = -200;     /* Distance, Azimuth, Inclination and Twist */
// GLfloat xRotation = 105,         define the viewing position 
//         yRotation = 180,
//         zRotation = 30;

/*GLfloat xRotation = 105,         angled orientation viewed from corner
        yRotation = 180,
        zRotation = 30; */
GLfloat xRotation = 0,        //viewed from top
        yRotation = 0,
        zRotation = 0; 
char string[] = "A";
...
static void Reshape( int width, int height )
{
   ...
   glLoadIdentity();
   glFrustum( -1.0, 1.0, -1.0, 1.0, 5.0, Far );
